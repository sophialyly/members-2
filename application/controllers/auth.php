...
class Auth extends CI_Controller {
	...
	function create_user()
	{
		...
		if ($this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data,$this->data))
		{
	...
	function edit_user($id=0)
	{
		...
		$this->form_validation->set_rules('date_format','Date Format', 'xss_clean');
		...
		$this->data['language'] = array(
			...
			'id'    => 'language',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('language', $user->language),
		);
		$this->data['date_format'] = array(
			'name'  => 'date_format',
			'id'    => 'date_format',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('date_format', $user->date_format),
		);
		$this->data['password'] = array(
			'name' => 'password',
			'id'   => 'password',
		...
		$this->data['single'] =  $this->setting_model->get();
